...
if __name__ == '__main__':
    ...
    # dataset and path
    parser.add_argument('--data_paths', nargs='+', default=["../datasets/primevul/balance_8models/gen_cluster/train.json"])
    parser.add_argument('--test_data_paths', nargs='+', default=["../datasets/primevul/balance_8models/gen/test.json"])
    parser.add_argument('--test_data_type', nargs='+', default=["multi_attempt"])
    parser.add_argument('--final_eval_data_paths', nargs='+', default=["../datasets/primevul/balance_8models/gen/test.json"])
    ...
    parser.add_argument('--save_path', type=str, default='./logs/router_primevul_gen_8models/')
