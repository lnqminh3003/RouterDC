...
for seed in "${seeds[@]}"; do
    ...
    --test_data_paths "./datasets/primevul/balance_8models/gen_cluster/test_shuffle1.json" \
    --test_data_type "multi_attempt" \
    --final_eval_data_paths "./datasets/primevul/balance_8models/gen_cluster/test_shuffle1.json" \
